...
function Home() {
  ...
  return ( <>
    <Link className="btn" to="/job" style={{borderRadius: "50px", width: "300px", height: "50px" , position:"absolute" , marginTop: "10px" , marginLeft: "300px"  , backgroundColor: "#FF7F30" , color: "white" , alignContent:"center"}} ><b>Find Your Dream Job Now</b></Link>
      <div className="row">
            <div className="col-8">
